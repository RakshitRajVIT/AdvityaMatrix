  ...
  return (
    (<div
      ...
      <h1 className="text-2xl md:text-6xl font-bold dark:text-white">
        Event Highlights: The Matrix Club 
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200">
        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quisquam mollitia, repudiandae atque officia, iusto eaque sed illo alias quis eos exercitationem voluptates nesciunt dignissimos harum, aliquid rerum natus in voluptas.
      </p>
    </div>)
  );
};
